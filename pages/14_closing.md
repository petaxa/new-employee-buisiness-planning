...
<div class="slide-container" data-screen-label="13 クロージング" style="position:absolute; left:0; top:0; width:1920px; height:1082px; transform:scale(0.5104166667); transform-origin:top left; overflow:hidden; background:#ffffff;">
  ...
  <div data-object="true" data-object-type="shape" style="position:absolute; left:120px; top:130px; width:6px; height:820px; background:#E5006E; z-index:1;"></div>
  ...
  <!-- メインメッセージ -->
  <div data-object="true" data-object-type="textbox" style="position:absolute; left:170px; top:200px; width:1600px; z-index:10;">
    <div style="font-size:88px; font-weight:900; line-height:1.2; color:#0B1F3A; letter-spacing:-1px;">空席を減らし、<br>出演者を救い、<br>ファンに <span style="color:#E5006E;">「出会い」</span> を届ける</div>
  </div>
  ...
  <div data-object="true" data-object-type="shape" style="position:absolute; left:1250px; top:740px; width:520px; height:180px; background:#0B1F3A; border-radius:10px; z-index:1;"></div>
  <div data-object="true" data-object-type="textbox" style="position:absolute; left:1290px; top:770px; width:440px; z-index:10;">
    <div style="font-family:'Inter',sans-serif; font-size:12px; letter-spacing:3px; color:#FFD2E4; font-weight:700;">FOR THE INDUSTRY</div>
    <div style="font-size:24px; font-weight:900; color:#ffffff; line-height:1.3; margin-top:8px;">流通の構造変革</div>
    <div style="font-size:16px; color:#D1D5DB; line-height:1.6; margin-top:6px;">小規模会場のチケット流通を再設計する</div>
  </div>

  <!-- 仕切り線 -->
  <div data-object="true" data-object-type="shape" style="position:absolute; left:170px; top:980px; width:1600px; height:1px; background:#E5E7EB; z-index:1;"></div>

  <!-- フッター -->
  <div data-object="true" data-object-type="textbox" style="position:absolute; left:170px; top:1005px; width:1200px; z-index:10;">
    <div style="font-size:18px; font-weight:700; color:#0B1F3A;">Thank you. ／ ご意見・ご相談、お待ちしております</div>
  </div>
